    ...
    public partial class SeedMoreProducts : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { "This is the description for product 1. Make the description interesting with at least 1000 characters. and make sure that the description is long enough to wrap to the next line.", "https://via.placeholder.com/250", 9.99m, "Product 1" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { "This is the description for product 2. Make the description interesting with at least 1000 characters. and make sure that the description is long enough to wrap to the next line.", "https://via.placeholder.com/250", 19.99m, "Product 2" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { "This is the description for product 3. Make the description interesting with at least 1000 characters. and make sure that the description is long enough to wrap to the next line.", "https://via.placeholder.com/250", 29.99m, "Product 3" });
        }
    }
}
